...
Criei este projeto para descobrir se uma nova estratégia de ensino (B) realmente traz resultados melhores do que a tradicional (A) nas notas de matemática. A ideia foi usar estatística para sair do "achismo" e entender se a diferença de desempenho é real ou apenas coincidência.

* O que foi feito
  
Simulei notas de 100 alunos (50 para cada método) e apliquei um Teste Z. O foco foi verificar se a média da Estratégia B é superior à da A, o que caracteriza um teste unilateral à direita.
